...
savepath1      <- paste0("F:/experiment/ML 2021/Result/",paste0("BATBooks-r-",Dataset[d_index],".txt"))
savepath2      <- paste0("F:/experiment/ML 2021/Result/",paste0("BATBooks-r-all-",Dataset[d_index],".txt"))
