...
Dataset        <- c("a9a","magic04","SUSY","SUSY-v")

savepath1      <- paste0("F:/experiment/ML 2021/Result/",paste0("Adv-BOKS-c-",Dataset[d_index],".txt"))
savepath2      <- paste0("F:/experiment/ML 2021/Result/",paste0("Adv-BOKS-c-all-",Dataset[d_index],".txt"))
