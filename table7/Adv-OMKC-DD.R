...
savepath1      <- paste0("F:/experiment/ML 2021/Result/",paste0("Adv-OMKC-DD-",Dataset[d_index],".txt"))
savepath2      <- paste0("F:/experiment/ML 2021/Result/",paste0("Adv-OMKC-DD-all-",Dataset[d_index],".txt"))
